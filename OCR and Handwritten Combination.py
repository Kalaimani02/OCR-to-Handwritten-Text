...
def lineToImg(line):
    ...
    for letter in line:
        ...
        char_images.append(crop(char_img, 27))   # Cropping to reduce width and arranging it in char_images list
...
rescaled = rescale(image, 0.25, 0.23)    # Adjust width and Height of the final Image
